...
author_columns = ["AuthorNum", "Name", "LastName", "ORCID"]
...
with open('UKCCHArticles201910CR.csv', 'w', newline='') as csvfile:
...
with open('UKCCHAuthors201910CR.csv', 'w', newline='') as csvfile:
...
with open('UKCCHArtAutLink201910CR.csv', 'w', newline='') as csvfile:
